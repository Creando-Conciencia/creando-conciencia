  ...
  authors: {
    ...
    authors: [
      ...
      },
      {
        ...
        affiliation: "Universidad Juárez Autónoma de Tabasco",
        bio: `<p>Doctor en Químicca. Investigador y divulgador científico comprometido con la comunicación efectiva de la ciencia. Co-conductor del programa "Creando Conciencia", especializado en hacer accesible el conocimiento científico a la comunidad.</p>`,
      },
      {
        name: "Dr. José Aurelio Sosa Olivier",
        role: "Coautor - Vox Populi",
        affiliation: "Universidad Juárez Autónoma de Tabasco",
        bio: `<p>Doctor en Ciencias en Ecología y Manejo de Sistemas Tropicales. Responsable de la Vox Populi del programa. Investigador y divulgador científico comprometido con la comunicación efectiva de la ciencia. Co-conductor del programa "Creando Conciencia", especializado en hacer accesible el conocimiento científico a la comunidad.</p>`,
      },
      {
      ...
      },
      {
        ...
        affiliation: "Universidad Juárez Autónoma de Tabasco",
        bio: `<p>Mestro en Ciencias. Investigador y divulgador científico comprometido con la comunicación efectiva de la ciencia. Co-conductor del programa "Creando Conciencia", especializado en hacer accesible el conocimiento científico a la comunidad.</p>`,
      },
      {
        name: "Lic. Yara García Robles",
        role: "Productora del Programa Creando Con Ciencia: La ciencia que transforma",
        affiliation: "Universidad Juárez Autónoma de Tabasco",
        bio: `<p>Licenciada en Ciencias de la Comunicación. Investigador y divulgador científico comprometido con la comunicación efectiva de la ciencia. Co-conductor del programa "Creando Conciencia", especializado en hacer accesible el conocimiento científico a la comunidad.</p>`,
      },
      {
        name: "MC. David Alberto Laines Vázquez",
        role: "Coautor - Editor Técnico",
        affiliation: "Instituto Técnologico de Monterrey",
        bio: `<p>Mestro en Ciencias de la Computación. Investigador y divulgador científico comprometido con la comunicación efectiva de la ciencia. Co-conductor del programa "Creando Conciencia", especializado en hacer accesible el conocimiento científico a la comunidad.</p>`,
      },
      {
        name: "MIA. Jesús Manuel Carrera Velueta",
        role: "Coautor - Coeditor Técnico",
        affiliation: "Universidad Juárez Autónoma de Tabasco",
        bio: `<p>Mestro en Inteligencia Artificial. Investigador y divulgador científico comprometido con la comunicación efectiva de la ciencia. Co-conductor del programa "Creando Conciencia", especializado en hacer accesible el conocimiento científico a la comunidad.</p>`,
      },
      {
        name: "Kenia Leticia Utrera Cabrera",
        role: "Colaboradora",
