      ...
      pages: [
        ...
        } as PageContent,
       {
        ...
        } as PageContent,
        {
          ...
          <p><strong>Dr. Roberto Hernández Barajas: Y precisamente esto es porque la actividad humana tiene impactos, y justamente eso quería preguntarles a los doctores: ¿qué estrategias podrían implementarse para mitigar el impacto humano en estos ecosistemas? </p></br>
